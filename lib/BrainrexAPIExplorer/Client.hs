...
module BrainrexAPIExplorer.Client where
...
dispatchLbs
  ...
  -> BrainrexAPIExplorerConfig -- ^ config
  -> BrainrexAPIExplorerRequest req contentType res accept -- ^ request
